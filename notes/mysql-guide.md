...
> **配套课程**：Phase 2.5 第 9 周 — [MySQL 数据库运维](../CURRICULUM.md#六phase-25mysql-数据库运维第-9-周)
...
👉 [**MySQL 跨平台安装与安全配置完全指南**](../mysql/cross-platform-install.md)
...
### 1️⃣ [安装与基础使用](../mysql/01-install-and-basics.md)
...
**更多内容 →** [`mysql/01-install-and-basics.md`](../mysql/01-install-and-basics.md)

---

### 2️⃣ [用户与安全加固](../mysql/02-user-and-security.md)
...
**更多内容 →** [`mysql/02-user-and-security.md`](../mysql/02-user-and-security.md)

---

### 3️⃣ [备份与恢复](../mysql/03-backup-and-recovery.md)
...
**更多内容 →** [`mysql/03-backup-and-recovery.md`](../mysql/03-backup-and-recovery.md)

---

### 4️⃣ [性能调优](../mysql/04-performance-tuning.md)
...
**更多内容 →** [`mysql/04-performance-tuning.md`](../mysql/04-performance-tuning.md)

---

### 5️⃣ [主从复制与高可用](../mysql/05-replication-and-ha.md)
...
**更多内容 →** [`mysql/05-replication-and-ha.md`](../mysql/05-replication-and-ha.md)

---

### 6️⃣ [监控](../mysql/06-monitoring.md)
...
**更多内容 →** [`mysql/06-monitoring.md`](../mysql/06-monitoring.md)

---

### 7️⃣ [常见故障排查](../mysql/07-common-faults.md)
...
**更多内容 →** [`mysql/07-common-faults.md`](../mysql/07-common-faults.md)

---

### 8️⃣ [卸载与清理](../mysql/08-uninstall-and-cleanup.md)

安全卸载 MySQL 和清理环境的完整流程——包括备份数据、逐层卸载包、删除数据目录、清理残余配置。同时涵盖 Docker 部署的清理方法。

**更多内容 →** [`mysql/08-uninstall-and-cleanup.md`](../mysql/08-uninstall-and-cleanup.md)

---

## 🧪 动手实验

> **建议**：按顺序完成，每完成一个更新 [PROGRESS.md](../PROGRESS.md) 打勾。

| # | 实验 | 时长 | 前置知识 | 内容 |
|---|------|------|---------|------|
| 1 | [部署与安全加固](../mysql/labs/lab-01-deploy-and-harden.md) | 60 min | 章节 1、2 | 从零部署 → 安全加固 → 验证 |
| 2 | [基于时间点的恢复（PITR）](../mysql/labs/lab-02-pitr-recovery.md) | 45 min | 章节 3 | 模拟误删 → binlog 精确恢复 |
| 3 | [主从复制与故障切换](../mysql/labs/lab-03-replication-failover.md) | 60 min | 章节 5 | 配置主从 → 模拟宕机 → 切换 |
