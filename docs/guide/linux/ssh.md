...
结合 [Linux 系统加固](/guide/security/system-hardening) 的完整清单。
...
**背景**：刚装好 Ubuntu Server，要从本机 SSH 登录。
...
| [Bash 脚本与巡检](/guide/automation/bash-scripts) | 配套练习 |
